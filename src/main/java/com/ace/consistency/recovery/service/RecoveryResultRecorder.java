...
public class RecoveryResultRecorder {
	...
	public RecoveryResult record(Long verificationResultId, String checkName, RecoveryAction action, RecoveryOutcome outcome) {
		return repository.save(RecoveryResult.from(verificationResultId, checkName, action, outcome, LocalDateTime.now()));
	}
}
